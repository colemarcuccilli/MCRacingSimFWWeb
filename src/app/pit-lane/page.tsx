...
export default function PitLanePage() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Package features - use fromTo for reliability
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto px-6 pitlane-hero-content">
          ...
          <p className="telemetry-text text-lg text-pit-gray max-w-2xl mb-8">
            Epic for them. Effortless for you. You bring the crew (up to 10 racers),
            we provide the track, the cars, and the Race Director.
          </p>

          <div className="flex flex-wrap gap-4">
            <Button href="#birthday-package" size="lg">
              View Birthday Package
            </Button>
            <Button href="#corporate" variant="secondary" size="lg">
              Corporate Events
            </Button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="racing-headline text-4xl md:text-5xl text-grid-white mb-4">
              <ScrambleText text="Birthday Race" />
              <span className="text-telemetry-cyan"> Package</span>
            </h2>
            <p className="telemetry-text text-pit-gray max-w-xl mx-auto">
              Up to 10 racers. 3 hours of exclusive facility access.
              Everything handled by our professional Race Director.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {partyInclusions.map((item, i) => (
              <div
                key={i}
                className="inclusion-item bg-asphalt-dark p-6 border border-white/5 hover:border-apex-red/30 transition-all group"
              >
          ...
          <div className="rotation-section max-w-4xl mx-auto">
            <div className="bg-asphalt-dark border border-white/10 p-8">
              ...
              <p className="telemetry-text text-sm text-pit-gray text-center mb-8">
                How 10 kids use 3 simulators: Non-stop action, zero downtime.
              </p>
              ...
              <div className="space-y-4">
                {rotationSteps.map((step, i) => (
                  <div
                    key={i}
                    className="rotation-step flex items-start gap-4 p-4 bg-asphalt border border-white/5"
                  >
                    ...
                    <div className="flex-grow">
                      <p className="racing-headline text-grid-white mb-1">
                        {step.activity}
                      </p>
                      <p className="telemetry-text text-sm text-pit-gray">
                        {step.secondary}
                    ...
                    <div className="w-8 h-8 bg-apex-red/20 flex items-center justify-center flex-shrink-0">
                      <span className="racing-headline text-sm text-apex-red">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="corporate-content">
              ...
              <h2 className="racing-headline text-4xl md:text-5xl text-grid-white mb-6">
                <ScrambleText text="Team Building" /> at
                <span className="text-apex-red"> 200 MPH</span>
              </h2>
              <p className="telemetry-text text-pit-gray leading-relaxed mb-8">
                Settle the office rivalry on the track. Our corporate packages
                deliver an unforgettable team experience that actually brings
                people together—through competition.
              </p>

              <ul className="space-y-4 mb-8">
                {[
                  'Private facility rental',
                  'Custom championship formats',
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="racing-headline text-3xl md:text-4xl text-grid-white mb-4">
              Frequently Asked
              <span className="text-telemetry-cyan"> Questions</span>
            </h2>
          </div>
          ...
          <div className="space-y-4">
            {[
              {
                q: 'What ages are appropriate for birthday parties?',
                a: 'Our simulators work great for ages 8 and up. The RC track is suitable for all ages with parental supervision.',
              },
              {
                q: 'Can we bring our own food and cake?',
                a: 'Yes! You are welcome to bring food, cake, and decorations. We have a dedicated party space with tables and chairs.',
              },
              {
                q: 'What if someone has never raced before?',
                a: 'No experience needed! Our Race Director will provide a full briefing and our simulators have adjustable difficulty settings.',
              },
              {
                q: 'How far in advance should we book?',
                a: 'We recommend booking at least 2 weeks in advance, especially for weekend parties. Popular dates fill up fast.',
              },
              {
                q: 'Is there a deposit required?',
                a: 'Yes, a 50% deposit is required to secure your booking. The remaining balance is due on the day of the event.',
              },
            ].map((faq, i) => (
              <details
                key={i}
                className="faq-item group bg-asphalt-dark border border-white/10 hover:border-white/20 transition-colors"
              >
                <summary className="flex items-center justify-between p-6 cursor-pointer list-none">
                  <span className="racing-headline text-lg text-grid-white pr-4">
                    {faq.q}
                  </span>
                ...
                <div className="px-6 pb-6">
                  <p className="telemetry-text text-pit-gray">{faq.a}</p>
                </div>
              </details>
            ))}
          </div>
